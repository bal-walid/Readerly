...
const Home = () => {
  return (
    <>
      ...
      <CurrentlyReading/>
      <h2 className="secondary-header my-5 flex max-sm:flex-col items-center">Recommended For You<Link to={'/recommended'} className="ml-auto max-sm:ml-0 text-base hover:text-text-main">See More &gt;</Link></h2>
      <RecommendedForYou/>
